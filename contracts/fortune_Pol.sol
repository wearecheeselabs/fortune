...
// File: contracts/fortune_pol.sol
...
contract FortunePol is ERC1155, Pausable, ERC1155Burnable {
    ...
    function mintAll(address[] memory _to)
    external
    whenNotPaused
    {
        onlyOwner();
    ...
    function batchWhitelistAddress(address[] memory _addresses, uint256 _id) public
        //    onlyOwner
        //    validTokenId (_id)
    {
        onlyOwner();
    ...
    function batchRemoveWhitelist(address[] memory _addresses, uint256 _id) public
        //    onlyOwner
        //    validTokenId (_id)
    {
        onlyOwner();
